...
<br/><br/>
<form action='dmverify.php' method='POST'>
<table width='30%'>
<tr>
...
<td>:</td>
<td><input type='text' name='fdoc' class='text5' /required value="<?php echo $row2['family_doc']?>">
<font color='red'>*</td>
</tr>
<tr><td><font size='5'>Name of Consulting Doctor</td>
<td>:</td>
<td><input type='text' name='cdoc' class='text5' /required value="<?php echo $row2['consulting_doc']?>">
<font color='red'>*</td>
</tr>
<tr><td><font size='5'>Name of Consulting Hospital</td>
<td>:</td>
<td><input type='text' name='hosp' class='text5' /required value="<?php echo $row2['consulting_hos']?>">
<font color='red'>*</td>
</tr>
<tr><td><font size='5'>Medical Insurance No.</td>
<td>:</td>
<td><input type='text' name='mino' class='text5' value=<?php echo $row2['medi_no']?>></td>
</tr>
</table>
<table width='50%'>
...
<td><font size='5'>Yes<input type='radio' name='medtime' value='Yes'></td><td><font size='5'>If Yes?<input type='text' name='medtext' class='text5'></td>
