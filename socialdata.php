...
<br/><br/>
<form  action='sdverify.php' method='POST'>
<table width='30%'>
<tr>
...
<td>:</td>
<td><input type="text" name="national" /required class="text4" value=<?php echo $row2['nationality']?>><font color='red'>*</font></td></tr>
<tr>
...
<td>:</td>
<td><input type='text' name='migrate' class="text4" value=<?php echo $row2['migrated']?>></td></tr>
<tr>
...
<td>:</td>
<td><input type='text' name='soc' class="text4" value=<?php echo $row2['social_contri']?>></td></tr>
<tr>
<td><font size='5'>Driving License No.</td>
<td>:</td>
<td><input type='text' name='drive' class="text4" value=<?php echo $row2['driving_no']?>><font color='red'>*</font></td></tr>
</table>
<center>
