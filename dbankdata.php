...
<br/><br/>
<form action='dbverify.php' method='POST'>
<table width='30%'>
<tr>
...
<td>:</td>
<td><input type='text' name='occupation'  /required class="text5" value=<?php echo $row2['occupation']?>><font color='red'>*</font></td></tr>
<tr>
<td><font size='5'>Name of the Bank</td>
<td>:</td>
<td><input type='text' name='bname'  /required class="text5" value=<?php echo $row2['bank_name']?>><font color='red'>*</font></td></tr>
<tr>
<td><font size='5'>Account Number</td>
<td>:</td>
<td><input type='text' name='baccount' pattern=[0-9]{11} /required class="text5" value=<?php echo $row2['acc_no']?>><font color='red'>*</font></td></tr>
<tr>
<td><font size='5'>Branch of the Bank</td>
<td>:</td>
<td><input type='text' name='bbranch'  /required class="text5" value=<?php echo $row2['branch']?>><font color='red'>*</font></td></tr>
<tr>
<td><font size='5'>IFSC Number</td>
<td>:</td>
<td><input type='text' name='bifsc' pattern=[A-Z]{3}[0-9]{8} /required class="text5" value=<?php echo $row2['IFSC_no']?>><font color='red'>*</font></td></tr>
<tr>
<td><font size='5'>Account Held in the Name of</td>
<td>:</td>
<td><input type='text' name='bjoint' class="text5" value=<?php echo $row2['acc_in_name']?>></td></tr>
<tr>
<td><font size='5'>Bank Card Number</td>
<td>:</td>
<td><input type='text' name='bcard' pattern='[0-9]{10}' class="text5" value=<?php echo $row2['bank_card']?>>
</p></table>
